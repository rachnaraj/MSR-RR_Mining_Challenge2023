...
if __name__ == "__main__":
    ...
    output_folder_path = r'D:\Me\concordia\Notes\Prof-Diego\MSR-DataChallenge\Implementation\Phase-seven-version-sugg-user'  # Replace with the desired output folder
