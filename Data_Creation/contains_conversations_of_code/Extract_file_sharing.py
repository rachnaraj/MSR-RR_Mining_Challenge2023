...
def extract_info(file_path):
    with open(file_path, 'r', encoding='utf-8') as file:
        ...
        for source in data.get('Sources', []):
            ...
            ObjectSha = source.get('ObjectSha', '')
            CommitSha = source.get('CommitSha', '')
            CommitMessage = source.get('CommitMessage', '')
...
def process_files(output_folder):
    file_path = r"D:\Me\concordia\Notes\Prof-Diego\MSR-DataChallenge\Implementation\Dataset_v9\DevGPT\snapshot_20231012\20231012_234250_file_sharings.json"
...
if __name__ == "__main__":
    output_folder_path = r'D:\Me\concordia\Notes\Prof-Diego\MSR-DataChallenge\Implementation\git-folder-MSR\MSR-RR_Mining_Challenge2023\Data_Creation\Contains_conversations_of_code'
