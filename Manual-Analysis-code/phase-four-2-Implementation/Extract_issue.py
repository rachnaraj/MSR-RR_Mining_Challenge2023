                        ...
                        if conversation.get('ListOfCode') != []:
                            ...
                            if any(
                                ...
                                relevant_conversations.append({
                                    ...
                                    'Conversations': chatgpt_sharing['Conversations'],  # Append the entire conversation object
                                })
...
if __name__ == "__main__":
    ...
    output_folder_path = r'D:\Me\concordia\Notes\Prof-Diego\MSR-DataChallenge\Implementation\git-folder-MSR\MSR-RR_Mining_Challenge2023\Manual-Analysis-code'  # Replace with the desired output folder
    file_pattern = '*_issue_sharings.json'
